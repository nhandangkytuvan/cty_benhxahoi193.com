	...
	<div class="menu-benh">
		<div class="container">
			<div class="flex flex1 justify-content-between">
                ...
                <div class="flex1col1 flex align-items-center justify-content-center">
                    <a href="{{ MyAPI::getUrlTermID(28) }}" class="text-container-center hvr-fade" title="Sùi mào gà">Sùi mào gà</a>
                </div>
                <div class="flex1col1 flex align-items-center justify-content-center">
                    <a href="{{ MyAPI::getUrlTermID(30) }}" class="text-container-center hvr-fade" title="Bệnh lậu">Bệnh lậu</a>
                </div>
                <div class="flex1col1 flex align-items-center justify-content-center">
                    <a href="{{ MyAPI::getUrlTermID(29) }}" class="text-container-center hvr-fade" title="Giang mai">Giang mai</a>
                </div>
                <div class="flex1col1 flex align-items-center justify-content-center">
                    <a href="{{ MyAPI::getUrlTermID(31) }}" class="text-container-center hvr-fade" title="Mụn rộp sinh dục">Mụn rộp sinh dục</a>
                </div>
            </div>
		</div>
	</div>
	<main class="home">
		<div class="container">
				...
				<div class="nth2">
					...
					<div class="nth22 flex flex2 justify-content-between">
						...
						<div class="pos-relative">
							...
							<div class="pos-absolute" style="padding-top: 10px;">Kĩ thuật điều trị đặc biệt</div>
						</div>
					</div>
				</div>
				<div class="nth3">
			...
			<div class="row7">
				...
				<div class="bg">
					<div class="flex flex1 justify-content-between">
						<div class="flex1col1">
							<div class="bg2">
								<div class="title1">Thương hiệu nam khoa chuyên nghiệp</div>
								<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en" class="dis-table">
									<span class="table-cell">Tìm hiểu thêm</span>
									<span class="table-cell">
										<img src="{{ asset('public/css/desktop/img/home-24.png') }}" alt="">
									</span>
								</a>
							</div>
						</div>
						<div class="flex1col2">
							<div class="bg2">
								<div class="title1">Phòng khám không ngày nghỉ 365 ngày</div>
								<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en" class="dis-table">
									<span class="table-cell">Tìm hiểu thêm</span>
									<span class="table-cell">
										<img src="{{ asset('public/css/desktop/img/home-24.png') }}" alt="">
						...
						<div class="flex1col3">
							<div class="bg2">
								<div class="title1">Môi trường thoải mái dễ chịu</div>
								<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en" class="dis-table">
									<span class="table-cell">Tìm hiểu thêm</span>
									<span class="table-cell">
										<img src="{{ asset('public/css/desktop/img/home-24.png') }}" alt="">
			...
			<div class="row8">
				...
				<div class="nth2">
					<div class="flex flex1 justify-content-between">
						<a class="flex1col1" href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en">Tư vấn<br>đặt hẹn</a>
						<a class="flex1col1" href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en">Đến khám</a>
						<a class="flex1col1" href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en">Lễ tân<br>hướng dẫn</a>
						<a class="flex1col1" href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en">Bác sĩ<br>thăm khám</a>
						<a class="flex1col1" href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en">Kiểm tra<br>chính xác</a>
						<a class="flex1col1" href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en">Dùng thuốc<br>đúng bệnh</a>
						<a class="flex1col1" href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en">Chỉ dẫn<br>chăm sóc</a>
					</div>
				</div>
				<div class="nth3">
			...
			<div class="row9">
				...
				<div class="dis-table table1 width-100">
					<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en" class="table-cell cell1">Phòng khám nào ở Hà Nội uy tín?</a>
					<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en" class="table-cell cell2">Xếp hạng phòng khám chữa bệnh xã hội ở Hà Nội</a>
					<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en" class="table-cell cell3">Phòng khám chữa sùi mào gà tốt nhất Hà Nội</a>
				</div>
				<div class="dis-table table2 width-100">
					<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en" class="table-cell cell1">Làm thế nào lựa chọn phòng khám chính quy?</a>
					<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en" class="table-cell cell2">Kĩ thuật điều trị của phòng khám nào tốt ở Hà Nội?</a>
					<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en" class="table-cell cell3">Điện thoại tư vấn Phòng khám Nam Khang</a>
				</div>
				<div class="dis-table table3 width-100">
					<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en" class="table-cell cell1">Phòng khám chuyên khoa Nam Khang có tốt không?</a>
					<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en" class="table-cell cell2">Phòng khám chữa bệnh xã hội nào tốt nhất Hà Nội?</a>
					<a href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en" class="table-cell cell3">Địa chỉ Phòng khám Nam Khang ở đâu?</a>
				</div>
				<div class="nth4">
					<a class="dis-table" href="http://swt.phongkham193.com/LR/Chatpre.aspx?id=MFI63108226&cid=1489654963660812714370&lng=en">
						<div class="table-cell cell1">></div>
